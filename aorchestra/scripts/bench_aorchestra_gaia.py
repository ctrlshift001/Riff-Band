...
from aorchestra.benchmark.aorchestra_bench_gaia import GAIAOrchestraBenchmark
from aorchestra.benchmark.gaia.tools import (
    GoogleSearchAction,
    ExecuteCodeAction,
...
async def main():
    ...
    from aorchestra.benchmark.bench_gaia import GAIAConfig
    gaia_cfg = GAIAConfig(
